    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="sales-add.php">Add Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            ...
            <input type="hidden" name="new" value="1" />
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="int" name="qtt" id="qtt" class="form-control" require="reqired">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <input type="text" name="buyer" id="buyer" class="form-control" require="reqired">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="pack" id="pack" class="form-control" require="reqired">
                </div>
              </div>

              <div class="text-center">
                <input type="submit" name="bsave" class="btn btn-primary" value="Save">
            ...
            if(isset($_POST['bsave']))
            {
              ...
              <div align='center'><i class='bi bi-check-circle me-1'></i> Data is successfully added </div>
