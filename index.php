              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                                    ...
                                    if(ISSET($_POST['submit']))
                  {
                    ...
                    $query = mysqli_query($conn, "SELECT * FROM acc WHERE username = '$username' AND password = '$password'");
                    ...
                    else
                    {
                      ...
                      <a class='btn btn-close' data-bs-dismiss='alert' aria-label='Close'></a></div>";
                    }
                  }
                  ?>
